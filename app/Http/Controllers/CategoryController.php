...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($is_mobile) {
            return view('pages.mobile.categories.index', compact('categories'));
        }

        return view('pages.desktop.categories.index', compact('categories'));
    }
    ...
    public function show(Category $category)
    {
        ...
        // Set current category for the view
        ...
        if ($is_mobile) {
            return view('pages.mobile.products.index', [
                'products' => $products,
        ...
        return view('pages.desktop.products.index', [
            'products' => $products,
            'categories' => $categories,
            'currentCategory' => $currentCategory,
            'title' => $category->name
