...
class OrderStatusChangedNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        if ($this->newStatus === 'approved') {
            $message->line('Pesanan Anda telah disetujui dan sedang diproses.');
        } elseif ($this->newStatus === 'delivered') {
            $message->line('Pesanan Anda telah berhasil dikirim! Silakan periksa email Anda untuk informasi lebih lanjut.');
        } elseif ($this->newStatus === 'canceled') {
            $message->line('Pesanan Anda telah dibatalkan. Silakan hubungi kami jika Anda memiliki pertanyaan.');
        }

        return $message->line('Terima kasih telah berbelanja di Premium Everyday!');
    }
