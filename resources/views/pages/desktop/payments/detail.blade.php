...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:py-8 mt-16">
                    ...
                    <dl class="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <dd class="mt-1">
                                    <a href="{{ $order->midtransTransaction->pdf_url }}" target="_blank"
                                        class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md shadow-sm text-white bg-pink-600 hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500">
                        ...
                        @if ($order->payment_status == 'pending')
                            <div class="sm:col-span-2 pt-2 mt-2 border-t border-gray-200">
                                <p class="text-sm text-gray-600 mb-3">Anda dapat melanjutkan pembayaran kapan saja, bahkan
                                    jika sebelumnya telah menutup halaman pembayaran Midtrans.</p>
        ...
        <!-- For Midtrans payment method with pending status -->
        @if ($canRetryPayment && $order->payment_method == 'midtrans')
            <div class="bg-white rounded-lg shadow mb-6">
                ...
                <div class="p-6">
                    <p class="text-sm text-gray-600 mb-4">Anda dapat melanjutkan pembayaran kapan saja untuk
                ...
                @if (in_array($order->status, ['completed', 'active', 'approved']) || $canLeaveReview)
                    ...
                    @else
                        <div class="text-center py-6">
                            ...
                            @else
                                <div class="mt-6">
                                    <p class="text-sm text-gray-500 italic">Anda dapat memberikan review setelah pembayaran
                                        selesai</p>
                                </div>
                            @endif
                        </div>
