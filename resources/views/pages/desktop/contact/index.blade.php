...
@section('content')
    <div class="contact-section min-h-screen py-12 pt-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <!-- Header -->
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold text-gray-900 mb-4">Get in Touch</h2>
                <p class="max-w-2xl mx-auto text-gray-600">Have a question, feedback, or need assistance? We're here to
                    help! Fill out the form below and we'll get back to you as soon as possible.</p>
            </div>

            @if (session('success'))
                <div class="max-w-3xl mx-auto bg-green-100 border-l-4 border-green-500 text-green-700 p-4 mb-8 rounded-lg shadow-sm"
                    role="alert">
                    <div class="flex">
            ...
            <div class="max-w-6xl mx-auto">
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-1 space-y-6">
                        <div class="contact-card bg-white p-6 rounded-lg">
                            <div class="flex items-start">
                                <div class="flex-shrink-0">
                                    <div
                                        class="contact-icon w-12 h-12 flex items-center justify-center bg-pink-100 rounded-full">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="mt-2 text-sm text-gray-500">Monday - Friday, 9am - 5pm WIB</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="contact-card bg-white p-6 rounded-lg">
                            <div class="flex items-start">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="mt-1 text-gray-600">info@premiumeveryday.com</p>
                                    <p class="mt-2 text-sm text-gray-500">We'll respond as soon as possible</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="contact-card bg-white p-6 rounded-lg">
                            <div class="flex items-start">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="mt-1 text-gray-600">Jl. Example No. 123, Jakarta Selatan</p>
                                    <p class="mt-2 text-sm text-gray-500">Jakarta, Indonesia 12345</p>
                                </div>
                            </div>
                        </div>
                    </div>
