...
@section('content')
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            @foreach($faqs as $index => $faq)
                <div x-data="{ open: false }" class="border border-gray-200 rounded-lg">
                    <button @click="open = !open" class="flex justify-between items-center w-full px-6 py-4 text-left">
                        ...
                        <svg class="h-6 w-6 text-gray-500 transform transition-transform duration-200" :class="{ 'rotate-180': open }" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="mt-12 text-center">
            ...
            <a href="https://wa.me/6281234567890?text=Halo, saya ingin bertanya tentang layanan Premium Everyday" class="mt-4 inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-pink-600 hover:bg-pink-700">
