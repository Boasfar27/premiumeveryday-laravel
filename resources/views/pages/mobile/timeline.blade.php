                    ...
                    <li>
                        <div class="relative pb-8">
                            ...
                            <div class="relative flex items-start space-x-3">
                                <div class="relative">
                                    <img class="h-8 w-8 rounded-full bg-gray-400 flex items-center justify-center ring-8 ring-white" src="{{ $timeline['image'] }}" alt="">
                                ...
                                <div class="min-w-0 flex-1">
                                    <div class="bg-white rounded-lg shadow-sm px-4 py-3 border border-gray-200">
                                        <div class="flex justify-between items-center mb-1">
                                            <div class="text-xs text-gray-500">{{ $timeline['date'] }}</div>
                                            @switch($timeline['type'])
                                                @case('promo')
                                        ...
                                        <h3 class="text-base font-medium text-gray-900">{{ $timeline['title'] }}</h3>
                                        <p class="mt-1 text-sm text-gray-700">{{ $timeline['description'] }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
