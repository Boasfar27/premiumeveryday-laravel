    ...
    <section id="testimonials" class="py-10 bg-gray-50">
        <div class="px-4 sm:px-6">
            <div class="text-center mb-8">
                ...
                <p class="mt-2 text-sm text-gray-600">Discover what our satisfied customers have to say about our services
                </p>
            </div>
            ...
            <div class="space-y-4">
                    ...
                    @foreach ($testimonials->take(3) as $testimonial)
                        <div class="bg-white p-4 rounded-lg shadow-sm">
                            <div class="flex items-center mb-3">
                                <div
                                    class="h-10 w-10 rounded-full bg-primary-100 flex items-center justify-center text-primary font-bold">
                ...
                @else
                    ...
                    <div class="text-center py-6">
                        <p class="text-gray-500 text-sm">There are currently no testimonials available.</p>
                    </div>
                @endif
            </div>
        </div>
