    ...
    <div class="min-h-screen bg-gray-100">
        ...
        <div class="px-4 py-6">
            ...
            <div class="bg-white rounded-lg shadow-sm">
                <div class="p-4 border-b border-gray-200">
                    <h2 class="text-lg font-medium text-gray-900">Edit Your Review</h2>
                </div>
                    ...
                    <form
                                ...
                                @for ($i = 1; $i <= 5; $i++)
                                    <div class="mr-1">
                                        ...
                                        <label for="rating-{{ $i }}" class="cursor-pointer">
                                            <svg class="h-6 w-6 {{ $i <= old('rating', $review->rating) ? 'text-yellow-400' : 'text-gray-300' }}"
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="content" name="content" rows="4"
                                ...
                                placeholder="Share your experience with this order..." required>{{ old('content', $review->content) }}</textarea>
                            @error('content')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
