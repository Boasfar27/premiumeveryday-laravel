        ...
        <div class="flex justify-between h-16">
                ...
                @else
                    <div class="flex items-center space-x-4">
                        ...
                        <a href="{{ route('register') }}"
                            class="bg-blue-600 text-white hover:bg-blue-700 px-4 py-2 rounded-md text-sm font-medium transition duration-150 ease-in-out">
                            Daftar
                        </a>
                    </div>
                @endauth
            ...
            <div class="-mr-2 flex items-center sm:hidden">
                <button @click="mobileMenu = !mobileMenu"
                    ...
                    <svg class="h-6 w-6" :class="{ 'hidden': mobileMenu, 'block': !mobileMenu }"
                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M4 6h16M4 12h16M4 18h16" />
                    </svg>
                    <svg class="h-6 w-6" :class="{ 'block': mobileMenu, 'hidden': !mobileMenu }"
                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
