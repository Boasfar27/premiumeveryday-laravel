        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center">
                    <a href="#products" class="text-gray-600 hover:text-gray-900 px-3 py-2">Produk</a>
                    <a href="#testimonials" class="text-gray-600 hover:text-gray-900 px-3 py-2">Testimoni</a>
                    <a href="#contact" class="text-gray-600 hover:text-gray-900 px-3 py-2">Kontak</a>
                </div>
            </div>
        </div>
    </nav>
